    ...
    return (
      <section className="nav-section">
        <nav className="nav-links">
            ...
            <svg className="hamburger-icon" xmlns="http://www.w3.org/2000/svg" width="39" height="24" fill="none"><path fill="#fff" d="M5.263.63.4 4.21h38.085V.63H5.263ZM.4 10.21v3.58h38.085v-3.58H.4ZM.4 19.79v3.58h34.218l3.867-3.58H.4Z"/></svg>
